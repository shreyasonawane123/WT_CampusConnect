    ...
    <div className='contact-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'>tur qui quos aspernatur, voluptatem autem possimus esse quo consequatur omnis, soluta consectetur ullam ipsum cum!</p>
            </div>
        </header>
            ...
            <div className='container'>
                ...
                <div className='row g-4'>
                    ...
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        ...
                        <h3 className='text-center mt-3'>Mumbai</h3>
                    </div>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        <img src={LiverpoolLocationImg} className='img-fluid' alt="" />
                        <h3 className='text-center mt-3'>Nagpur</h3>
                    </div>
                </div>
            </div>
        </div>
